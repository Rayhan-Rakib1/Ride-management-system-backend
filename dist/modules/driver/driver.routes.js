...
router.post('/create-driver', (0, validation_request_1.validationRequest)(driver_validation_1.createDriverZodSchema), driver_controller_1.DriverController.createDriver);
...
router.get('/ride-history/driver', (0, check_auth_1.checkAuth)(user_interface_1.Role.Driver), driver_controller_1.DriverController.getDriverRideHistory);
// Get driver's earnings history (driver only)
router.get('/earnings/driver', (0, check_auth_1.checkAuth)(user_interface_1.Role.Driver), driver_controller_1.DriverController.getDriverEarnings);
...
router.delete("/me", driver_controller_1.DriverController.deleteDriverAccount);
