...
const credentialLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!passwordMatched) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Password dose not matched");
    }
    const userTokens = (0, userToken_1.createToken)(isUserExist);
...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const newAccessToken = yield (0, userToken_1.getNewAccessTokenUsingRefreshToken)(refreshToken);
    return {
...
const resetPassword = (oldPassword, newPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isOldPassword = yield bcryptjs_1.default.compare(oldPassword, user.password);
    if (!isOldPassword) {
